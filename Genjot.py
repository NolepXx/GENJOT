...
class Logo:
   ...
   ____  _____ _________    ____  ____  _   __      ______  ________
  / __ \/ ___// ____/   |  / __ \/ __ \/ | / /     / __ \ \/ / ____/
 / / / /\__ \/ /   / /| | / / / / / / /  |/ /_____/ / / /\  / __/   
/ /_/ /___/ / /___/ ___ |/ /_/ / /_/ / /|  /_____/ /_/ / / / /___   
\____//____/\____/_/  |_/_____/\____/_/ |_/      \____/ /_/_____/                                                                                                           
  {B2} Made By {M2} NOLEPXXXX {P2}CYNAMOL OF SUGIONO FIGHT
{B2}╭──────────────────────╮{B2}╭───────────────╮{B2}╭────────────────────────────╮
{B2}│ {P2}Author : Nolep Xxx {B2}│{B2}│ {P2}Version : 2.2 {B2}│{B2}│ {P2}Recode By : NolepXx {B2}       │
