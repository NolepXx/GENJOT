...
class Logo:
    ...
    ______    ________  ______        __       ________      ______    _____  ___-     ______  ___  ___  _______  
   /    " \  /"       )/" _  "\      /""\     |"      "\    /    " \  (\"   \|"  \    /    " \|"  \/"  |/"     "| 
  // ____  \(:   \___/(: ( \___)    /    \    (.  ___  :)  // ____  \ |.\\   \    |  // ____  \\   \  /(: ______) 
 /  /    ) :)\___  \   \/ \        /' /\  \   |: \   ) || /  /    ) :)|: \.   \\  | /  /    ) :)\\  \/  \/    |   
(: (____/ //  __/  \\  //  \ _    //  __'  \  (| (___\ ||(: (____/ // |.  \    \. |(: (____/ // /   /   // ___)_  
 \        /  /" \   :)(:   _) \  /   /  \\  \ |:       :) \        /  |    \    \ | \        / /   /   (:      "| 
  \"_____/  (_______/  \_______)(___/    \___)(________/   \"_____/    \___|\____\)  \"_____/ |___/     \_______) 
                                                                                                                  
  Made By {M2} NOLEPXXXX {P2}CYNAMOL OF SUGIONO FIGHT
{B2}╭──────────────────────╮{B2}╭───────────────╮{B2}╭────────────────────────────╮
...
def scarpping_ua():
    ...
    header = {"apikey": "AIzaSyDpAzuUAjzCUc6BSNNyagVEYtp9fhHFCu0"}
